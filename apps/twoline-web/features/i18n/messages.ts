...
const MESSAGES: Record<AppLocale, MessageMap> = {
  ko: {
    ...
    "ledger.button.void": "삭제(VOID)",
    "ledger.button.reconcile": "대사 잠금",
    "ledger.button.unreconcile": "대사 해제",
    "ledger.button.closePeriod": "마감 잠금",
    "ledger.button.reopenPeriod": "마감 해제",
    ...
    "ledger.success.voided": "거래가 VOID 처리되었습니다.",
    "ledger.success.lockUpdated": "잠금 상태가 업데이트되었습니다.",
    ...
    "ledger.error.reconciledLocked": "대사 완료 거래는 먼저 대사 해제해야 수정/삭제할 수 있습니다.",
    "ledger.error.closedLocked": "마감 거래는 먼저 마감을 해제해야 수정/삭제할 수 있습니다.",
    "ledger.error.ownerRequired": "이 작업은 owner 권한이 필요합니다.",
    ...
    "ledger.meta.voided": "VOIDED",
    "ledger.meta.superseded": "SUPERSEDED",
    "ledger.filter.showVoided": "취소/교정 내역 포함 보기 (감사 뷰)",
    "ledger.lock.UNLOCKED": "잠금 없음",
    "ledger.lock.RECONCILED": "대사 잠금",
    "ledger.lock.CLOSED": "마감 잠금",
    ...
    "csv.label.excelBomHint": "Flat(BOM)은 엑셀 열기 호환성을 높입니다.",
    ...
    "csv.label.net": "순손익",
    "csv.label.appliedEntries": "반영된 항목(최대 5건)",
  ...
  en: {
    ...
    "ledger.button.void": "Delete (VOID)",
    "ledger.button.reconcile": "Reconcile Lock",
    "ledger.button.unreconcile": "Un-reconcile",
    "ledger.button.closePeriod": "Close Period",
    "ledger.button.reopenPeriod": "Reopen Period",
    ...
    "ledger.success.voided": "Transaction voided.",
    "ledger.success.lockUpdated": "Lock state updated.",
    ...
    "ledger.error.reconciledLocked":
      "Reconciled transactions must be un-reconciled before edit/delete.",
    "ledger.error.closedLocked":
      "Closed-period transactions must be reopened before edit/delete.",
    "ledger.error.ownerRequired": "This action requires owner permission.",
    ...
    "ledger.meta.voided": "VOIDED",
    "ledger.meta.superseded": "SUPERSEDED",
    "ledger.filter.showVoided": "Show voided/corrected history (audit view)",
    "ledger.lock.UNLOCKED": "Unlocked",
    "ledger.lock.RECONCILED": "Reconciled",
    "ledger.lock.CLOSED": "Closed",
    ...
    "csv.label.flatCsv": "Flat CSV",
    "csv.label.excelBomHint": "Flat (BOM) improves compatibility when opening in Excel.",
    "csv.label.importPayload": "Import Payload (JSON array)",
    "csv.label.forceMode": "Force mode (allow commit even with preview errors)",
    "csv.label.transactionSchema":
      "Schema (exact): 계정명, 날짜, 내용, 금액, 카테고리(nullable)",
    ...
    "csv.label.net": "Net",
    "csv.label.appliedEntries": "Applied entries (up to 5)",
